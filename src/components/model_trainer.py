...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_arr,test_arr):
        try:
            logging.info("split traing and testing input data")
            x_train,y_tarin,x_test,y_test=(
                train_arr[:,:-1],
                train_arr[:,-1],
                test_arr[:,:-1],
                test_arr[:,-1]
            ...
            model_report:dict=evaluate_models(X_train=x_train,y_train=y_tarin,X_test=x_test,y_test=y_test,
